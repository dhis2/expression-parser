...
import static org.hisp.dhis.expression.DescriptionTreeWalker.describe;
...
public class TypeCheckingNodeVisitor implements NodeVisitor {
    ...
    public void visitMethod(Node<NamedMethod> method) {
        Node<?> argument = method.child(0);
        checkArgumentTypeIsAssignable(method, argument, method.getValue().getParameterType(), argument.getValueType());
    }
