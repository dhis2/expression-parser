...
class EvaluateFunction implements NodeInterpreter<Object> {
    ...
    public Object evalFunction(Node<NamedFunction> fn) {
        ...
        switch (fnInfo) {
            ...
            case d2_condition: return functions.d2_condition(evalToBoolean(fn.child(0)), evalToMixed(fn.child(1)), evalToMixed(fn.child(1)));
            case d2_count: return functions.d2_count(evalToVar(fn.child(0)));
            case d2_countIfCondition: return 0d;
            case d2_countIfValue: return functions.d2_countIfValue(evalToMixed(fn.child(0)), evalToMixed(fn.child(1)));
            case d2_countIfZeroPos: return functions.d2_countIfZeroPos(evalToMixed(fn.child(0)));
            ...
            case d2_hasUserRole: return functions.d2_hasUserRole(evalToString(fn.child(0)));
            case d2_hasValue: return functions.d2_hasValue(evalToString(fn.child(0)));
            case d2_inOrgUnitGroup: return functions.d2_inOrgUnitGroup(evalToString(fn.child(0)));
            case d2_lastEventDate: return functions.d2_lastEventDate(evalToString(fn.child(0)));
            ...
            case d2_maxValue: return functions.d2_maxValue(evalToNumbers(fn.children()));
            case d2_minutesBetween: return functions.d2_minutesBetween(evalToDate(fn.child(0)), evalToDate(fn.child(1)));
            case d2_minValue: return functions.d2_minValue(evalToNumbers(fn.children()));
            ...
            case d2_relationshipCount: return functions.d2_relationshipCount(evalToString(fn.child(0)));
