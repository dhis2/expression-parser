...
internal class InOrgUnitGroupTest {
    ...
    fun testInOrgUnitGroup_Null() {
        ...
        val programRuleVariableValues = mapOf("org_unit" to RuleVariableValue(ValueType.STRING))
    ...
    fun testInOrgUnitGroup() {
        ...
        val programRuleVariableValues = mapOf("org_unit" to RuleVariableValue(ValueType.STRING).copy(value = "uiduser0001"))
